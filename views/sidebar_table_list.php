...
<div class="col-sm-3 sidenav">
    <a href="<?php echo SITE_ROOT;?>/table/new" class="btn btn-success form-control" align="left">
    ...
    ?>
        <div class="list-group-item tablelist" align="left">
            <a href="<?php echo SITE_ROOT."/table/$document"; ?>">
            ...
            <div class="dropdown pull-right">
                ...
                <div class="dropdown-menu dropdown-menu-left">
                    <a href="<?php echo BASE_URL."/insert/$document"; ?>"><label class="form-control dropdown-item rowadd core-control"><span class="glyphicon glyphicon-floppy-disk"></span><?php echo _t(14); ?></label></a>
                    <a href="<?php echo BASE_URL."/table/new/$document"; ?>"><label class="form-control dropdown-item tableadd core-control"><span class="glyphicon glyphicon-plus"></span><?php echo _t(15); ?></label></a>
