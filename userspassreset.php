                ...
                <table class="table table-hover">
                    ...
                    <tbody>
						...
						if ( ($_SERVER['REQUEST_METHOD'] == 'GET') and isset($_GET['search']) ) {$search = $_GET['search'];}
                            	...
                            	$select_users = "SELECT user_id, first_name, last_name from users where first_name like '%$search%' or last_name like '%$search%' or ni_no like '%$search%' ";
                            ...
                            while($r = mysqli_fetch_assoc($rows)){
                            	...
                            	echo '<tr>'; 
                            		...
                            		echo "<td class='text-center'><a class='Edit' href='userpassreset.php?id=$userid&search=$search'><i class='fas fa-key icon-black'></i></a></td>";
